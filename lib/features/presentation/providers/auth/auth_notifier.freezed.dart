...
abstract class $AuthStateCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {bool isLoggedIn, TrainerModel? trainer, String? error, bool isLoading});
...
class _$AuthStateImpl with DiagnosticableTreeMixin implements _AuthState {
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'AuthState(isLoggedIn: $isLoggedIn, trainer: $trainer, error: $error, isLoading: $isLoading)';
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ...
      ..add(DiagnosticsProperty('trainer', trainer))
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, isLoggedIn, trainer, error, isLoading);
